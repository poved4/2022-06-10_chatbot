...
public class ReaderTxt {
    ...
    File file = new File(Config.pathTxtFile);
    ...
    public String newQuestion(String pregunta, String respuesta) {
    ...
    public void save(String contenidoAnteriorTxt, String nuevapalabra) {
        try {
